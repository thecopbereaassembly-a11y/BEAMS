...
export const REPORTS: ReportDefinition[] = [
  ...
  },
  {
    key: "giving",
    name: "Contributions",
    description: "Every recorded gift with member, purpose, channel and amount.",
    module: "Finance",
    permission: "finance.read",
    columns: [
      { key: "date", label: "Date" },
      { key: "member", label: "From" },
      { key: "type", label: "For" },
      { key: "fund", label: "Fund" },
      { key: "channel", label: "Channel" },
      { key: "amount", label: "Amount (GHS)", numeric: true },
    ],
  },
  {
    key: "expenditure",
    name: "Expenditure",
    description: "Money spent, by category and fund.",
    module: "Finance",
    permission: "finance.read",
    columns: [
      { key: "date", label: "Date" },
